  ...
  <!--patient login page--><br><br><br>
    ...
    <div class="ui container login">
        <div class="ui red centered card">
                 ...
                 <form class="ui  form log"  action="login" method="post">
                         <div class="field">
                         <div  class="sixteen wide field">  
              <br>
                           <label class="header">User EmailId</label>
                           <input type="email" name="email" placeholder="Enter User EmailId">
                         </div>
                        </div>
                         <div class="field">
                        <div  class="sixteen wide field">   
                         ...
                         <div class="field">
                          ...
                          <a href="newuser.jsp" id="field1">Create account</a></p>
